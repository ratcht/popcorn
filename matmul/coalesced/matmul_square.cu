...
int main() {
  ...
  h_a_t = (int*)malloc( sizeof(int) * n * n);
  ...
  cudaMemcpy(d_a, h_a_t, sizeof(int) * n * n, cudaMemcpyHostToDevice);
  ...
  transpose(h_a_t, h_a, n);

  verify_result(h_a, h_b, h_c, n);

  printf("successful\n");

  printMatrix(h_a_t, n, n, "A_T");
  printMatrix(h_a, n, n, "A");
  printMatrix(h_b, n, n, "B");
  printMatrix(h_c, n, n, "C=AxB");
